...
stworzona w ramach pracy pozwala na generowanie danych, które inaczej mogłyby być ciężko dostępne, w celu nauki i doskonalenia umiejętności analizy metryk w projektach informatycznych. Takie podejście
umożliwia zespołom i osobom odpowiedzialnym za zarządzanie projektami zdobywanie doświadczenia w analizie metryk inżynierii oprogramowania bez konieczności pracy z prawdziwymi danymi, które mogą
być poufne lub po prostu trudne do zdobycia.
...
W podsumowaniu pracy omówione są korzyści wynikające z oferowanego rozwiązania. Dzięki narzędziu agilemaster użytkownicy mogą eksperymentować z danymi projektów przy minimalnej konfiguracji oraz w kontrolowanym środowisku bez ryzyka
...
Na końcu pracy omawiane są potencjalne kierunki dalszego rozwoju pracy, takie jak integracja z większą ilością platform lub zaawansowane ustawienia parametrów generowania danych.
} % koniec streszczenia
